...
import com.zimidy.api.layers.api.graphql.AppAuthenticationEntryPoint
...
internal class SecurityConfig(
    ...
    override fun configure(http: HttpSecurity) {
        ...
        //        http
//            .authorizeRequests()
//            .antMatchers("/oauth_login","/loginSuccess","/loginFailure",SOCIAL_GOOGLE_URI,SOCIAL_FACEBOOK_URI).permitAll()
//            .anyRequest()
//            .authenticated()
//            .and()
//            .oauth2Login()
//            .loginPage("/oauth_login").defaultSuccessUrl("/loginSuccess")
